...
DEP = "D : Volume des ventes"

valid = [v for v in VARS_FG if v in df.columns]
...
fig.suptitle(
    "Appendice C — Diagnostics des résidus MCO — FMCG",
...
fig.text(0.5, -0.01,
         ...
         "Source : Auteur, estimations MCO à partir des données propriétaires FMCG (2022–2024).",
         ha="center", fontsize=7.5, fontfamily=FONT,
         color="#777777", style="italic")

plt.tight_layout(pad=2.5)
output_path = "Appendice_C_Diagnostics_Residus_FG.png"
